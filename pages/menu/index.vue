...
<style scoped>
    @import "~assets/css/menu/style.min.css";
</style>
<script>
...
export default {
    ...
    data () {
        ...
        service: [
            ...
            { title: '查詢車輛', img: '/img/search.svg', link: '/modeChoose' },
            { title: '即時預約', img: '/img/calendar.svg', link: '/dateCoating' },
            { title: '預約記錄', img: '/img/assignment.svg', link: '/recordreServe' },
            { title: '紅利紀錄', img: '/img/money.svg', link: '/recordBonus' },
        ]
        }
    }
